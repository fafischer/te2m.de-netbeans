...
@OptionsPanelController.SubRegistration(
        location = "Te2m",
        displayName = "#AdvancedOption_DisplayName_Vertx",
        keywords = "#AdvancedOption_Keywords_Vertx",
        keywordsCategory = "Te2m/Maven"
)
@org.openide.util.NbBundle.Messages({"AdvancedOption_DisplayName_Vertx=Vertx Defaults", "AdvancedOption_Keywords_Vertx=vertx"})
public final class VertxPanelController extends OptionsPanelController {

    /**
     * The panel.
     */
    private VertxPanel panel;
     ...
     * @return the panel
     */
    private VertxPanel getPanel() {
        if (panel == null) {
            panel = new VertxPanel(this);
        }
        return panel;
    }
