...
/**
 * The Class DockerfileWizardPanel1.
 *
 * @author ffischer
 * @version 1.0
 * @since 1.0
 */
public class DockerfileWizardPanel1 implements WizardDescriptor.Panel<WizardDescriptor> {

    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private DockerfileVisualPanel1 component;
     ...
     */
    @Override
    public DockerfileVisualPanel1 getComponent() {
        if (component == null) {
            component = new DockerfileVisualPanel1();
        }
        return component;
    }
    ...
    private String getDescriptionFromVisualPanel() {
        return ((DockerfileVisualPanel1) component).getTargetDescription();
    }
    ...
    private String getNameFromVisualPanel() {
        return ((DockerfileVisualPanel1) component).getTargetName();
    }
    ...
    private String getPackageFromVisualPanel() {
        return ((DockerfileVisualPanel1) component).getTargetPackage();
    }
