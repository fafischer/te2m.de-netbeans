...
/**
 * The Class PFDataTableGenerator.
 *
 * @author ffischer
 * @version 1.0
 * @since 1.0
 */
public class PFDataTableGenerator extends AbstractCodeGenerator implements CodeGenerator {


    /**
     * Instantiates a new PF data table generator.
     *
     * @param context containing JTextComponent and possibly other items
     * registered by {@link CodeGeneratorContextProvider}
     */
    private PFDataTableGenerator(Lookup context) { // Good practice is not to save Lookup outside ctor
    ...
    protected String getContent() {
        return Templates.PF_DATA_TABLE;
    }
    ...
    public static class Factory implements CodeGenerator.Factory {
        ...
        public List<? extends CodeGenerator> create(Lookup context) {
            return Collections.singletonList(new PFDataTableGenerator(context));
        }
    }
