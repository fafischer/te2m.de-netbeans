/*
* NewTaglibDecriptorWizardPanel1.java
*   
...
* 
*/
package de.te2m.tools.netbeans.wizards.tld;
...
/**
 * The Class NewTaglibDecriptorWizardPanel1.
 *
 * @author ffischer
 * @version 1.0
 * @since 1.0
 */
public class NewTaglibDecriptorWizardPanel1 implements WizardDescriptor.Panel<WizardDescriptor> {

    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private NewTaglibDecriptorVisualPanel1 component;
     ...
     */
    @Override
    public NewTaglibDecriptorVisualPanel1 getComponent() {
        if (component == null) {
            component = new NewTaglibDecriptorVisualPanel1();
        }
        return component;
    }
    ...
    public void storeSettings(WizardDescriptor wiz) {
        ...
        wiz.putProperty(TemplateKeys.PROPERTY_FOLDER, getFolderFromVisualPanel());
        wiz.putProperty(TemplateKeys.PROPERTY_NAME_SPACE, getNameSpaceFromVisualPanel());
    }
    ...
    private String getNameFromVisualPanel() {
        return ((NewTaglibDecriptorVisualPanel1) component).getTargetName();
    }

    /**
     * Gets the name space from visual panel.
     *
     * @return the name space from visual panel
     */
    private String getNameSpaceFromVisualPanel() {
        return ((NewTaglibDecriptorVisualPanel1) component).getTargetNameSpace();
    }
    ...
    private String getDescriptionFromVisualPanel() {
        return ((NewTaglibDecriptorVisualPanel1) component).getTargetDescription();
    }
    ...
    private String getFolderFromVisualPanel() {
        return ((NewTaglibDecriptorVisualPanel1) component).getTargetFolder();
    }
