/*
* NewTaglibDecriptorWizardIterator.java
*   
...
/**
 * The Class NewTaglibDecriptorWizardIterator.
 *
 * @author ffischer
 * @version 1.0
 * @since 1.0
 */
@TemplateRegistration(folder = "JSF", displayName = "#NewTaglibDecriptorWizardIterator_displayName", description = "newTaglibDecriptor.html", iconBase = "de/te2m/tools/netbeans/icons/logo16.png", content = "TLD.xml.template", scriptEngine = "freemarker")
@Messages("NewTaglibDecriptorWizardIterator_displayName=New Taglib Descriptor")
public final class NewTaglibDecriptorWizardIterator implements WizardDescriptor.InstantiatingIterator<WizardDescriptor> {
    ...
    private List<WizardDescriptor.Panel<WizardDescriptor>> getPanels() {
        if (panels == null) {
            ...
            panels.add(new NewTaglibDecriptorWizardPanel1());
    ...
    public Set<?> instantiate() throws IOException {
        ...
        params.put(TemplateKeys.PROPERTY_NAME_SPACE, wizard.getProperty(TemplateKeys.PROPERTY_NAME_SPACE));
        ...
        FileObject res = lookupSubDir(resRoot, "META-INF");

        DataObject dobj = dTemplate.createFromTemplate(DataFolder.findFolder(res), fName + ".taglib.xml", params);
