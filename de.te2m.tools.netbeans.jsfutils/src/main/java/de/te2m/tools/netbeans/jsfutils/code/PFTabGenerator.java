 ...
 * @since 1.0
 */
public class PFTabGenerator extends AbstractCodeGenerator implements CodeGenerator {
     ...
     */
    private PFTabGenerator(Lookup context) { // Good practice is not to save Lookup outside ctor
    ...
    public static class Factory implements CodeGenerator.Factory {
        ...
        public List<? extends CodeGenerator> create(Lookup context) {
            return Collections.singletonList(new PFTabGenerator(context));
        }
    }
    ...
    public String getDisplayName() {
        return "PrimeFaces Tab Component";
    }
