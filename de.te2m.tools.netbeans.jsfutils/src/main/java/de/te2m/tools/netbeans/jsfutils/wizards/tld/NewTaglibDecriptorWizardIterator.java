 ...
 * @since 1.0
 */
@TemplateRegistration(folder = "JSF", displayName = "#NewTaglibDecriptorWizardIterator_displayName", description = "newTaglibDecriptor.html", iconBase = "de/te2m/tools/netbeans/jsfutils/icons/logo16.png", content = "TLD.xml.template", scriptEngine = "freemarker")
